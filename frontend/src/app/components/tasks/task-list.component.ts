...
@Component({
  ...
  templateUrl: '../../templates/task-list.component.html',
  styleUrls: ['../../styles/task-list.component.css']
})
export class TaskListComponent implements OnInit, OnDestroy {
  ...
  getPages(): number[] {
    ...
    if (this.totalPages <= maxPagesToShow) {
      ...
      // Caso contrário, exibe um subconjunto centrado na página atual
      let startPage = Math.max(1, this.currentPage - Math.floor(maxPagesToShow / 2));
      let endPage = startPage + maxPagesToShow - 1;
      
      // Ajusta se ultrapassar o total de páginas
